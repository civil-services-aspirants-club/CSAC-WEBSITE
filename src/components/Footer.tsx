import { GraduationCap, Mail, Phone, MapPin, Instagram, Linkedin, MessageCircle } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-primary-foreground/80 mb-4 max-w-md">
              ...
              lead, and serve the nation.
            </p>
            <div className="flex space-x-4">
              <div className="w-10 h-10 bg-accent rounded-full flex items-center justify-center hover:bg-accent-dark transition-colors cursor-pointer">
